...
const Chat = ({ chatService, kakaoService }) => {
  ...
  const movePosition = (posSocketData) => {
    ...
    if (nickname != myName) {
      ...
      if (usersMarkers[nickname.toString()]) {
        console.log('if 안쪽');
        usersMarkers[nickname.toString()].setMap(null);
      }
      if (location) {
        ...
        setUsersMarkers({ ...usersMarkers, [nickname.toString()]: marker });
      }
    }
  };
