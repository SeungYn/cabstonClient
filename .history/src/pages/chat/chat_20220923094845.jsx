...
const Chat = ({ chatService, kakaoService }) => {
  ...
  const onDragHeandler = (e) => {
    console.log(mapContainerRef.current.getBoundingClientRect());
    console.log(mapParent.current.getBoundingClientRect().left);
    mapContainerRef.current.style.left = `${
      posX -
      mapContainerRef.current.getBoundingClientRect().width / 2 -
