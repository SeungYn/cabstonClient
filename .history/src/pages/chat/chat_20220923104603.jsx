...
const Chat = ({ chatService, kakaoService }) => {
  ...
  const onDragHeandler = (e) => {
    let move = posX - shiftX - mapParent.current.getBoundingClientRect().left;
    if (
      move + mapContainerRef.current.getBoundingClientRect().width >
    ...
    mapContainerRef.current.style.left = `${move}px`;
    console.log(
      posX,
      shiftX,
