...
const Chat = ({ chatService }) => {
  ...
  useEffect(() => {
    ...
    chatService.getMyInfo().then((data) => {
      ...
      chatSync = chatService.onChatSync('chat', (data) => {
        console.log('emitchat');
        return onCreated(data);
      });
      inSync = chatService.onChatSync('join', (data) => console.log(data));
      exitSync = chatService.onChatSync('exit', (data) => console.log(data));
